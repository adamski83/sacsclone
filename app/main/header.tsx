	...
	return (
		<div className="w-full flex flex-col h-auto sm:h-a justify-center bg-orange-900">
			<div className="flex flex-col sm:flex-row sm:my-3 justify-center sm:justify-between items-center mt-4 sm:mt-0">
				<div className="flex flex-col sm:flex-row gap-5 ml-3.5 mr-3.5 mt-5 ">
					<button className="flex justify-around btn btn-outline hover:bg-yellow-500">
						<Phone className="mr-2" />
						<span className=" sm:inline">+1234567890</span>
					</button>
					<button className="flex justify-around  btn btn-outline hover:bg-yellow-500">
						<Mail className="mr-2" />
						info@boki.com
